---
title: "File Metadata Analyzer Project Report"
collection: portfolio
permalink: /portfolio/file-metadata-analyzer-project-report/
...
**Significance:** File metadata plays a crucial role in digital investigations, providing evidence for timeline reconstruction, location verification, and authorship attribution. This tool demonstrates both the investigative value and privacy risks associated with metadata.
...
**Primary Objective**: Develop a functional tool for extracting and analyzing file metadata
...
**New** **Contribution**: Specialized metadata analysis with integrated forensic assessment, privacy evaluation, and educational focus.
...
![Screenshot](/images/projects/file-metadata-analyzer-project-report/image_1.png)
...
**Extraction**: MetadataExtractor reads file and extracts all metadata

**Analysis**: MetadataAnalyzer examines metadata for forensic significance

**Reporting**: MetadataReporter generates formatted output

**Output**: Reports in JSON/CSV/Text format, GPS maps
...
![Screenshot](/images/projects/file-metadata-analyzer-project-report/image_2.png)
...
![Screenshot](/images/projects/file-metadata-analyzer-project-report/image_3.png)
...
![Screenshot](/images/projects/file-metadata-analyzer-project-report/image_4.png)

When we have coordinates. 

![Screenshot](/images/projects/file-metadata-analyzer-project-report/image_5.png)

![Screenshot](/images/projects/file-metadata-analyzer-project-report/image_6.png)
...
![Screenshot](/images/projects/file-metadata-analyzer-project-report/image_7.png)
...
![Screenshot](/images/projects/file-metadata-analyzer-project-report/image_8.png)
...
![Screenshot](/images/projects/file-metadata-analyzer-project-report/image_9.png)
...
![Screenshot](/images/projects/file-metadata-analyzer-project-report/image_10.png)
...
![Screenshot](/images/projects/file-metadata-analyzer-project-report/image_11.png)

After sanitizing.

![Screenshot](/images/projects/file-metadata-analyzer-project-report/image_12.png)
...
![Screenshot](/images/projects/file-metadata-analyzer-project-report/image_13.png)
...
All the file types in the table below achieved a 100% success rate.
...
![Screenshot](/images/projects/file-metadata-analyzer-project-report/image_14.png)

### 6.4 Document Metadata Analysis

**Author Information:**

2/5 PDFs contained author metadata

6/10 DOCX files had comprehensive properties

2/5 XLSX files had creator information

**Revision History:**

Average revision count: 3.2 (for documents with history)

Some documents showed
...
![Screenshot](/images/projects/file-metadata-analyzer-project-report/image_15.png)
...
![Screenshot](/images/projects/file-metadata-analyzer-project-report/image_16.png)
...
Processor: AMD Ryzen 7 5800U 16CPUs
...
80% of test files contained more metadata than expected
...
**Comprehensive Coverage**: Supports major file formats

**Accurate Extraction**: 100% success rate on supported formats

**Intelligent Analysis**: Detects subtle anomalies

**User-Friendly**: Clear CLI and readable reports

**Educational**: Demonstrates forensic concepts effectively

**Limitations:**

**Format Support**: Cannot handle proprietary/obscure formats

**Encryption**: Cannot analyze encrypted files

**Dependency**: Requires FFmpeg for video (external)

**Performance**: Video analysis slower than images/documents

**Anti-Forensics**: Sophisticated tampering may evade detection
...
Metadata formats are inconsistent and complex

Graceful error handling is critical

Modular design enables easy extension

Testing with diverse file types essential

Performance optimization matters for scalability

**Forensic Lessons:**

Metadata often overlooked but highly valuable

Timestamp anomalies are strong indicators

GPS data is extremely sensitive

Document metadata reveals more than expected

Privacy and forensics are dual concerns

**Project Management Lessons:**

Iterative development effective for this scope

Early testing revealed design issues

Documentation as important as code

User perspective guides feature priority
...
**Reliability**: Methods are scientifically sound

**Relevance**: Evidence material to the case
...
Corroborate metadata with other evidence

Be aware of anti-forensic possibilities
...
Check files for metadata before sharing

Use sanitization tools when appropriate

Disable GPS tagging if not needed

Review document properties before distribution

Understand what your files reveal

Use privacy-respecting applications
...
Provide sanitization tools to employees

Train staff on privacy implications
...
All the objectives were achieved and evidenced as follows in the below

### 9.3 Key Contributions

**Technical Contributions:**

Integrated solution combining extraction, analysis, and visualization

Forensic analysis algorithms for anomaly detection
...
Comprehensive demonstration of metadata forensics

Privacy awareness raising

Anti-forensics education

Practical tool for learning

**Practical Contributions:**

Open-source tool for small-scale investigations
...
**Format Coverage**: Limited to common formats

**Performance**: Video analysis relatively slow

**Anti-Forensics**: Sophisticated tampering detection limited

**Scalability**: No database for large-scale analysis
...
**Metadata is ubiquitous** - Nearly all digital files contain more information than visible content

**Metadata is valuable** - Provides timeline, location, and attribution evidence

**Metadata is vulnerable** - Often unprotected and easily accessible

**Metadata is dual-purpose** - Both an investigative tool and privacy concern

**Awareness is crucial** - Education benefits all stakeholders
...
Garfinkel, S. (2007). "Forensic Feature Extraction and Cross-Drive Analysis." Digital Investigation.

### Technical Documentation

EXIF 2.3 Standard (2012). Japan Electronics and Information Technology Industries Association.
...
"How GPS in Photos Led to Arrests" - Various news sources

"Document Metadata Leaks Expose Sources" - Security blogs

"The Privacy Implications of Photo Metadata" - Privacy research papers

## 11. Appendices

### Appendix A: Installation Guide

Detailed installation instructions are outlined in QUICKSTART.md and README.md files.

### Appendix B: User Manual

For comprehensive documentation usage see README.md.
...
Sample output reports are available in the output/ directory. This is when CLI is used.
...
| Case 1: John McAfee (2012) | Vice Magazine published photo with GPS coordinates in EXIF <br> Revealed location of fugitive software developer <br> Demonstrated privacy risks of geotagged photos |
| --- | --- |
| Case 2: Corporate Document Leaks | Leaked documents traced through author metadata <br> Revision history revealed multiple contributors <br> Timestamps established timeline of document creation |
| Case 3: Digital Photo Forensics | EXIF data verified authenticity of evidence photos <br> GPS coordinates corroborated witness testimony <br> Camera serial numbers linked to specific devices |
...
| File Type | Avg. Extraction Time | Notes |
| --- | --- | --- |
| JPEG Images | 0.08s | Fast EXIF parsing |
| PNG Images | 0.06s | Minimal metadata |
| PDF Documents | 0.15s | Larger file size |
| DOCX Files | 0.12s | ZIP-based format |
| XLSX Files | 0.14s | Similar to DOCX |
| MP3 Files | 0.10s | ID3 tags |
| MP4 Files | 0.25s | FFmpeg required |
...
| Objective | Evidence |
| --- | --- |
| Functional metadata extraction | 100% success rate on 50 test files |
| Multi-format support | Images, PDFs, DOCX, XLSX, media |
| Forensic analysis | Anomaly detection, risk assessment |
| GPS visualization | Interactive maps generated |
| Metadata sanitization | 96%+ metadata removal |
| Report generation | JSON, CSV, text formats |
| Educational value | Clear demonstrations, documentation |
